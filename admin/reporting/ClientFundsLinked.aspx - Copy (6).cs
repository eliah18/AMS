...
public partial class admin_ClientStatus_ClientFundsLinked : System.Web.UI.Page
{
    ...
    public Boolean removeinvestmentCounter(string id)
    {
        {
