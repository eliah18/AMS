<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Reporting/ReportingClientSelection.master" AutoEventWireup="true" CodeFile="ClientsInvestments.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <%--<h4 class="page-title">Reporting>>Client Selection </h4><br />--%>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Reporting>>Client Selection</li>   
                    </ol>
                </nav>
