<%--<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Reporting/Reporting.master" AutoEventWireup="true" CodeFile="BarGraphTest.aspx.cs" Inherits="admin_parameters_User" %>--%>
...
<%@ Page Title="Chart-100% Stacked Column-ASP.NET-SYNCFUSION" Language="C#" MetaDescription="This sample demonstrates how to render 100% stacked column series using Syncfusion ASP.NET Web Forms Chart control" MasterPageFile="~/admin/Reporting/Reporting.master" AutoEventWireup="true" CodeBehind="BarGraphTest.aspx.cs" Inherits="WebSampleBrowser.Chart.StackingColumn100" %>
...
<asp:Content ID="ControlContent" runat="server" ContentPlaceHolderID="body">
