...
public partial class admin_parameters_User : System.Web.UI.Page
{
    ...
    public void loadreport(String clientid,String quarter, String year, String  quarterto,String yearto)
    {
        ...
        strscript += "window.open('QuartertoQuarterReport.aspx?year=" + year.ToString() + " &quarter=" + quarter.ToString() + "  &clientid=" + clientid.ToString() + "  &quarterto=" + quarterto.ToString() + " &yearto=" + yearto.ToString() + "');";
        strscript += "</script>";
