    ...
    <div class="inside">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <%--<h4 class="page-title center">&nbsp;&nbsp;Reporting>>Client Selection>>Reporting Dashboard>>Report Creation>>Asset Class Allocation</h4>--%>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Reporting>>Client Selection>>Reporting Dashboard>>Report Creation>>Asset Class Allocation</li>   
                    </ol>
                </nav>
        ...
        <div class="border-top">
         ...
         <contenttemplate>
            <asp:Timer ID="Timer1"  Interval="3000" OnTick="Timer1_Tick"    runat="server"></asp:Timer>
             <div class="center">
                <asp:Label ID="lblwarning" runat="server" Text="Are you sure you want clear all the table?" class="col-sm-2 text-right control-label col-form-label" visible="false"/>     
            </div>
            <div class="center">
                <asp:Button ID="btnYes"  class="btn btn-primary" OnClick="Button1_ClickYes" runat="server" Text="Yes" visible="false"/>
                <asp:Button  ID="btnNo"  class="btn btn-primary" OnClick="Button1_ClickNo" runat="server" Text="No" visible="false"/>
              </div>
            ...
            <RowStyle BackColor="#EFF3FB" CssClass="rowstyle" />
                                            ...
                                            <div class="center">
                                                ...
                                                <asp:Button  ID="Button7"  class="btn btn-primary" OnClick="linkDiscard_Click" runat="server" Text="Clear Table" />
                                                <%--<asp:LinkButton OnClientClick="if (!confirm('Are you sure you want clear all assets?')) return false;" ID="lnkDiscard" runat="server" OnClick="linkDiscard2">Clear Table</asp:LinkButton>--%>
