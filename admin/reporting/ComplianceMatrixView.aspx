<%--<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Reporting/ReportingViews.master" AutoEventWireup="true" CodeFile="ComplianceMatrixView.aspx.cs" Inherits="admin_parameters_User" %>--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Reporting/Reporting.master" AutoEventWireup="true" CodeFile="ComplianceMatrixView.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                       <%-- <h4 class="page-title">&nbsp;&nbsp;Reporting>>Client Selection>>Reporting Dashboard>>Report Viewing>>Asset Class Holding>>Compliance Matrix </h4><br />--%>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Reporting>>Client Selection>>Reporting Dashboard>>Report Viewing>>Compliance Matrix</li>                                   
                            </ol>
                        </nav>
...
<%--                                            <asp:TextBox ID="txtRole"  class="form-control" runat="server"></asp:TextBox>--%>
                                    ...
                                    <div class="form-group row">
                                        <asp:Label ID="Label2" runat="server" Text="" visible="true" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                        <div class="center">  
                                            &nbsp&nbsp&nbsp&nbsp
                                            <asp:Button ID="Button6" runat="server" class="btn btn-primary" Text="Back" OnClick="Button13_Click" />
