...
public partial class admin_ClientStatus_ClientFundsLinked : System.Web.UI.Page
{
    ...
    private Boolean CheckCounterExistance(String counter)
    {
        conn.Close();
        ...
        try
        {
            ...
            this.subaccount = Request.QueryString["subaccount"];
            conn.Open();
            String query = "  select z.counter from linked_assetclasses z join para_company b on z.counter= b.company  where z.client_id='" + clientid + "' and z.assetclass='" + assetclass + "' and z.assetmanager='" + assetmanager + "' and z.year='" + year + "' and z.quarter='" + quarter + "' and z.subaccount='" + this.subaccount + "' and z.counter= '" + counter + "' and z.active=1";
            SqlCommand cmd = new SqlCommand(query, conn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet("ds");
            da.Fill(ds);
    ...
    {
        {
            ...
            conn.Close();
            conn.Open();
            String query = " select distinct( z.id)  as  id,z.counter,z.value from linked_assetclasses z join  bonds_and_debentures b on z.counter= b.bondname  where z.client_id='" + clientid + "' and z.assetclass='" + assetclass + "' and z.assetmanager='" + assetmanager + "' and z.year='" + year + "' and z.quarter='" + quarter + "' and z.subaccount='" + this.subaccount + "' and z.active=1 ";
            SqlCommand cmd = new SqlCommand(query, conn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet("ds");
            da.Fill(ds);
    ...
    private void loadcounters()
    {
        ...
        rdCounters.DataBind();
        rdCounters.Items.Insert(0, new ListItem("Select Counter Party", "0"));
    ...
    {
        rdCounters.SelectedItem.Text = "Select Counter Party";
        txtMoneyMarketType.Text = "";
        txtValue.Text="";
        rdBonds.SelectedItem.Text = "Select Bond";
        txtbondtype.Text = "";
        txtBondvalue.Text = "";
        rdlistedequities.SelectedItem.Text = "Select Company";
        txtlistedEquityType.Text = "";
        txtPrice.Text = "";
        txtQuantity.Text = "";
        //rdListedProperty.SelectedItem.Text = "Select Company";
        //txtListedPropertyType.Text = "";
        txtListedPropertyPrice.Text = "";
        txtListedPropertyValue.Text = "";
        rdForeignEquity.SelectedItem.Text = "Select Counter";
        txtForeignEquityType.Text = "";
        txtForeignEquityValue.Text = "";

        //rdUnlistedProperty.SelectedItem.Text = "Select Property";
        //txtUnlistedPropertyType.Text = "";
        txtUnlistedPropertyValue.Text = "";
        //rdUnlistedEquity.SelectedItem.Text = "Select Equity";
        //txtUnlistedEquityType.Text = "";
        txtUnlistedEquityValue.Text = "";

        txtAlternativeInvestmentValue.Text = "";
        txtCashValue.Text = "";
        txtGFundValue.Text = "";
        txtCashNostroValue.Text = "";
    ...
    public void linkDiscard(object sender, System.EventArgs e)
    {
        ...
        int assetclassX = Int32.Parse(assetclass);
        //if (assetclassX > 6)
        if (assetclassX > 7)
        {            
    ...
    public double  fetchDeletValue(String id)
    {
        ...
        try
        {
            ...
            string Query = "select value from investments where  id='" + id.ToString() + "' ";
            SqlCommand cmd = new SqlCommand(Query, conn);
            SqlDataReader dr = cmd.ExecuteReader();
    ...
    public double fetchDeletValueUnlistedEquity(String id)
    {
        Double removeinvestmentvalue = 0;
         try
        {
    ...
    public double fetchDeletValueCounter(String id)
    {
        Double removeinvestmentvalue = 0;
        try
        {
...

    {
        ...
        try
        {
            ...
            this.subaccount = Request.QueryString["subaccount"];
            conn.Open();
            String query = " select z.id,z.counter,z.value from linked_assetclasses z join foreign_equities b on z.counter= b.company  where z.client_id='" + clientid + "' and z.assetclass='" + assetclass + "' and z.assetmanager='" + assetmanager + "'  and z.year='" + year + "' and z.quarter='" + quarter + "' and z.subaccount='" + this.subaccount + "' and z.active=1 ";
            SqlCommand cmd = new SqlCommand(query, conn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet("ds");
            da.Fill(ds);
    ...
    //if (insertlinked2(clientid," ", "0", "0", assetmanager, assetclass," ", txtUnlistedEquityValue.Text, year, quarter))
    ...
    protected void Unnamed_Click(object sender, EventArgs e)
    {
        ...
        if ((rdCounters.SelectedItem.Text == "Select Counter Party"))
        {
            MsgBox("Select Counter Party", Page, this);
            return;
        }
    ...
    public Boolean checkInvestment(String clientid, String year, String quarter, String assetclass, String assetmanager)
    {
...

        {
            this.subaccount = Request.QueryString["subaccount"];
            conn.Open();
            SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM Investments where client_id='" + clientid + "' and  year='" + year + "' and  quarter ='" + quarter + "' and Asset_manager_id ='" + assetmanager + "' and Asset_class_id='" + assetclass + "'  and subaccount='"+this.subaccount+"' and active='1'", conn);
    ...
    {        
        ...
        try
        {
            this.subaccount = Request.QueryString["subaccount"];
            conn.Open();
            SqlCommand cmd = new SqlCommand("select count(*) countListed from linked_assetclasses where counter='" + counter + "' and assetclass='" + assetclass + "' and assetmanager='" + assetmanager + "' and year='" + year + "' and quarter='" + quarter + "' and client_id= '" + clientid + "' and subaccount='"+this.subaccount+"' and active=1", conn);
            //int count = int.Parse(cmd.ExecuteScalar().ToString()); Farai counter
            int count = Convert.ToInt32(cmd.ExecuteScalar());
            //MsgBox("Counted "+ count+ " The Counter " + counter , this.Page, this);
            if (count >= 1)
            {
                existance = true;
                //fetchinvestmentupdateid(clientid, year, quarter, assetclass, assetmanager);
    ...
    public Boolean editmoneymoneymarketsum(string id) // Clear Button To Change Delete
    {
    ...
    //public Boolean isInlinked_assetclasses(String id)
    //{
    //    Boolean state = false;
    //    try
    //    {
    ...
    //        string Query = "select count(value) value from linked_assetclasses  where  id='" + id.ToString() + "' ";
    //        //string Query = "select count(value) value from investments where  id='" + id.ToString() + "' ";
    //        SqlCommand cmd = new SqlCommand(Query, conn);
    //        SqlDataReader dr = cmd.ExecuteReader();
    ...
    //        int removeinvestmentvalue = Convert.ToInt32(dr["value"]);
    //            if (removeinvestmentvalue>=1) 
    //            {
    //            state= true;
    //            }
    //            else
    ...
    public Boolean removeinvestment(string id)
    {
        ...
        {
            Double sum;
            //LEFT OFF NOT DELETING TRY 2
            //if (isInlinked_assetclasses(id))
            //{
            //    sum = fetchDeletValueUnlistedEquity(id);
            //}
            //else
            //{
                sum = fetchDeletValue(id);
            //}
            //---------------------------------------------------
            ...
            SqlCommand cmd = new SqlCommand("insert into Deleted_Investments (client_id,Asset_class_id,Asset_manager_id,value,year,quarter,date) values('" + clientid + "', '" + txtAssetclass.Text + "', '"+assetmanager+ "', '" + sum + "', '"+year+"', '"+ quarter + "', GETDATE())", conn);
            if ((conn.State == ConnectionState.Open))
                conn.Close();
            conn.Open();
            cmd.ExecuteNonQuery();
        ...
        
        {
            ...
            //if (isInlinked_assetclasses(id))
            //{
            //    SqlCommand cmd = new SqlCommand("Delete from linked_assetclasses where id='" + id + "' ", conn);
            //    if ((conn.State == ConnectionState.Open))
            //        conn.Close();
            //    conn.Open();
            //    cmd.ExecuteNonQuery();
            ...
            //else
            //{
                SqlCommand cmd = new SqlCommand("Delete from Investments where Id='" + id + "' ", conn);
                if ((conn.State == ConnectionState.Open))
                    conn.Close();
                conn.Open();
                cmd.ExecuteNonQuery();
    ...
    public Boolean removeinvestmentCounter(string id) // clear button to change check
    {
        {
            SqlCommand cmd = new SqlCommand("insert into Deleted_linked_assetclasses (counter,assetclass,price,quantity,client_id,active,assetmanager,type,value,year,quarter,subaccount,date) select counter, assetclass, price, quantity, client_id, active, assetmanager, type, value, year, quarter, subaccount, GETDATE() from linked_assetclasses where id = '" + id + "'", conn);
            if ((conn.State == ConnectionState.Open))
                conn.Close();
            conn.Open();
            cmd.ExecuteNonQuery();
        ...
        {
            Double sum = fetchDeletValueCounter(id);
            //Double.Parse(txtupdateoriginalvalue.Text);
            if (sum <= 0)
            {
                sum = 0;
            ...
            //UPDATE CounterInvestments
            SqlCommand cmd = new SqlCommand("update Investments set value=value-'" + sum + "' where client_id='" + clientid + "' and Asset_class_id='" + txtAssetclass.Text + "' and Asset_manager_id='" + assetmanager + "' and year='" + year + "' and quarter='" + quarter + "' ", conn);
            if ((conn.State == ConnectionState.Open))
                conn.Close();
            conn.Open();
            cmd.ExecuteNonQuery();
    ...
    protected void addlistedequity_Click(object sender, EventArgs e)
    {
        ...
        if (checkLinked(clientid, year, quarter, assetclass, assetmanager, rdlistedequities.SelectedItem.Value))
        {
    ...
    protected void addlistedproperty_Click(object sender, EventArgs e)
    {
        ...
        String year = Request.QueryString["year"];
        fetchcurrentlistedpropertysum(clientid, year, quarter, txtAssetclass.Text, assetmanager);
        if ((rdListedProperty.SelectedItem.Text == "Select Company"))
        {
            MsgBox("Select Counter", Page, this);
            return;
        }
        ...
        if (checkLinked(clientid, year, quarter, assetclass, assetmanager, rdListedProperty.SelectedItem.Value))
        {
    ...
    public void fetchcurrenttotalmoneymarket(String clientid, String year, String quarter, String assetclass, String assetmanager)
    {
        try
        {
            ...
            conn.Close();
            conn.Open();
            string Query = "   select id , value from  Investments where Asset_class_id='" + assetclass + "' and Asset_manager_id='" + assetmanager + "' and year='" + year + "' and quarter='" + quarter + "' and client_id = '" + clientid + "' and subaccount= '" + this.subaccount + "' and active=1";
            SqlCommand cmd = new SqlCommand(Query, conn);
            SqlDataReader dr = cmd.ExecuteReader();
    ...
    public void fetchlistedEquitysum(String clientid, String year, String quarter, String assetclass, String assetmanager)
    {
        ...
        conn.Close();
        conn.Open();
        string Query = "   select id ,  value from  Investments where Asset_class_id='" + assetclass.ToString() + "' and Asset_manager_id='" + assetmanager + "' and year='" + year + "' and quarter='" + quarter + "' and client_id = '" + clientid + "' and subaccount='"+this.subaccount+"' and active=1";
        SqlCommand cmd = new SqlCommand(Query, conn);
        SqlDataReader dr = cmd.ExecuteReader();
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        String year = Request.QueryString["year"];
        fetchcurrentunlistedpropertysum(clientid, year, quarter, txtAssetclass.Text, assetmanager);
        if (rdUnlistedProperty.SelectedItem.Text == "Select Property")
        {
    ...
    private void GetunListedProperty()
    {
        ...
        try
        {
            ...
            conn.Open();
            String query = " select z.id,z.counter,z.value from linked_assetclasses z join unlisted_property b on z.counter= b.propertyname  where z.client_id='" + clientid + "' and z.assetclass='" + assetclass + "' and z.assetmanager='" + assetmanager + "' and z.year='" + year + "' and z.quarter='" + quarter + "' and z.subaccount='" + this.subaccount + "' and z.active=1 ";
            SqlCommand cmd = new SqlCommand(query, conn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet("ds");
            da.Fill(ds);
        ...
        {
            conn.Close();
            //MsgBox("GetunListedProperty " + ex.Message, this.Page, this);
        }
    }
...

    {
        ...
        try
        {
            ...
            this.subaccount = Request.QueryString["subaccount"];
            conn.Open();
            //String query = " select top 1 id, isnull(value,0) AS [value] FROM (select z.id as id,z.value as value,z.client_id as client_id,x.id as assetclass,Asset_manager_id as assetmanager, z.quarter as quarter,z.year as year,z.subaccount as subaccount,z.active as active from investments z join assets_class x on z.Asset_class_id=x.asset_name) y where client_id='" + clientid + "' and assetclass='" + assetclass + "' and assetmanager='" + assetmanager + "' and year='" + year + "' and quarter='" + quarter + "' and subaccount='" + this.subaccount + "' and active=1 order by id desc  ";
            
            String query = " select z.id,z.counter,z.value from linked_assetclasses z join unlisted_equity b on z.counter= b.equityname where z.client_id='" + clientid + "' and z.assetclass='" + assetclass + "' and z.assetmanager='" + assetmanager + "'  and z.year='" + year + "' and z.quarter='" + quarter + "' and z.subaccount='" + this.subaccount + "' and z.active=1 ";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    //MsgBox(ds.ToString(), this.Page, this);
                    //MsgBox("B4 databind => " + grdUnlistedEquity.Rows[1].Cells[1].Text.ToString(), this.Page, this);              
                    grdUnlistedEquity.DataBind();
                    //MsgBox("After databind", this.Page, this);
                }
            }
            else
            {
        ...
        {
            conn.Close();
            //MsgBox("Edit Error Occured For Unlisted Equity" + ex.Message, this.Page, this);
        }
    }
    ...
    public void FetchCurrentCashSum(String clientid, String year, String quarter, String assetclass, String assetmanager)
    {
        try
        {
            ...
            else
            {
                ...
                Label42.Text = "0";
                //MsgBox("if (dr.Read() <> true) !!!" + Label42.Text, Page, this);
        ...
        {
            {
                if (checkInvestment(clientid, year, quarter, txtAssetclass.Text, assetmanager))
                {
                    UpdateInvestment(clientid, txtAssetclass.Text, assetmanager, txtCashNostroValue.Text, year, quarter, Label62.Text); //Label X
                }
                else
                {
    ...
    public void fetchAlternativeInvestmentData(String id)
    {
        try
        {
            conn.Close();
            conn.Open();
            string Query = "select z.id,z.value from linked_assetclasses z join alternative_investments b on z.counter= b.investmentname  where  z.id='" + id.ToString() + "'  ";
            SqlCommand cmd = new SqlCommand(Query, conn);
            SqlDataReader dr = cmd.ExecuteReader();
    ...
    {        
        try
        {
            conn.Close();
            conn.Open();
            string Query = "select z.id,z.value from linked_assetclasses z join unlisted_equity b on z.counter= b.equityname  where  z.id='" + id.ToString() + "'";
            //string Query = "select * from Investments where id='" + id.ToString() + "'  ";
            SqlCommand cmd = new SqlCommand(Query, conn);
            SqlDataReader dr = cmd.ExecuteReader();                      
            ...
            {
                //MsgBox("Read not true", this.Page, this);
            }
        }
        catch (Exception ex)
        {
    ...
    public Boolean editUnlistedEquity(string id)
    {

        {
            ...
            //result = Int32.TryParse(id, out num);
            ...
            //MsgBox("Value "+ txtUnlistedEquityValue.Text + "| id " + id, Page, this);
            SqlCommand cmd = new SqlCommand("update linked_assetclasses set value='" + cma + "' where id= '" + result + "'", conn);
            if ((conn.State == ConnectionState.Open))
                conn.Close();
            conn.Open();
            cmd.ExecuteNonQuery();
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        if (insertlinked2(clientid, " ", "0", "0", assetmanager, assetclass, " ", txtAlternativeInvestmentValue.Text, year, quarter))
        {
            {
                if (checkInvestment(clientid, year, quarter, txtAssetclass.Text, assetmanager))
                {
    ...
    public void fetchcurrentalternativeinvestmentsum(String clientid, String year, String quarter, String assetclass, String assetmanager)
    {
        try
        {
            ...
            else
            {
                ...
                lbAlternativeInvestmentTotal.Text = "0";
                //MsgBox("if (dr.Read() <> true) !!!" + Label42.Text, Page, this);
                lbAlternativeInvestmentTotal.ForeColor = System.Drawing.Color.Gray;
                lbAlternativeInvestmentTotal.BackColor = System.Drawing.Color.White;
            }
        }
        catch (Exception ex)
        {
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        String year = Request.QueryString["year"];
        fetchcurrentunlistedpropertysum(clientid, year, quarter, txtAssetclass.Text, assetmanager);
        if (rdUnlistedEquity.SelectedItem.Text == "Select Equity")
        {
        ...
        /*if (insertlinked2(clientid, " ", "0", "0", assetmanager, assetclass, " ", txtUnlistedEquityValue.Text, year, quarter))*/
        if (insertlinked(clientid, rdUnlistedEquity.SelectedItem.Text, "0", "0", assetmanager, assetclass, " ", txtUnlistedEquityValue.Text, year, quarter))
        {
            {
                if (checkInvestment(clientid, year, quarter, txtAssetclass.Text, assetmanager))
                {
                ...
                MsgBox("Unlisted Equity Saved", Page, this);
                //fetchcurrentalternativeinvestmentsum(clientid, year, quarter, txtAssetclass.Text, assetmanager);
                fetchunlistedequitysum(clientid, year, quarter, txtAssetclass.Text, assetmanager);
                clearFields();
                GetUnlistedEquity();
    ...
    public void fetchunlistedequitysum(String clientid, String year, String quarter, String assetclass, String assetmanager)
    {
        try
        {
            conn.Close();
            conn.Open(); 
            string Query = "   select id , value from  Investments where Asset_class_id='" + assetclass + "' and Asset_manager_id='" + assetmanager + "' and year='" + year + "' and quarter='" + quarter + "' and client_id = '" + clientid + "' and active=1";
            SqlCommand cmd = new SqlCommand(Query, conn);
            SqlDataReader dr = cmd.ExecuteReader();
            ...
            else
            {
                ...
                lbtotalUnlistedEquty.Text = "0";
                //MsgBox("if (dr.Read() <> true) !!!" + Label42.Text, Page, this);
                lbtotalUnlistedEquty.ForeColor = System.Drawing.Color.Gray;
                lbtotalUnlistedEquty.BackColor = System.Drawing.Color.White;
            }
    ...
    {
        //MsgBox("Enter unlistedequityid_Click", this.Page, this); 
        string idd = ((LinkButton)sender).CommandArgument;
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        //MsgBox("Value " + txtUnlistedEquityValue.Text + "| id " + txtUnlistedEquityId.Text, Page, this);
