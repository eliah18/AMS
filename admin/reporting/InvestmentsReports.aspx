<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Clients/ClientStatus.master" AutoEventWireup="true" CodeFile="InvestmentsReports.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"> Quarterly  Investments Reports</h4><br />
