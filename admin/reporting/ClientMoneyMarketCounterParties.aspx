<%--<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Reporting/ReportingViews.master" AutoEventWireup="true" CodeFile="ClientMoneyMarketCounterParties.aspx.cs" Inherits="admin_parameters_User" %>--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Reporting/Reporting.master" AutoEventWireup="true" CodeFile="ClientMoneyMarketCounterParties.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <%--<h4 class="page-title">&nbsp;&nbsp;Reporting>>Client Selection>>Reporting Dashboard>>Report Viewing>>Asset Class Holding>>Money Market Counters</h4><br />--%>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Reporting>>Client Selection>>Reporting Dashboard>>Report Viewing>>Money Market Counters</li>                                   
                            </ol>
                        </nav>
      ...
      <div class="container-fluid">
          ...
          <asp:Panel ID="usersPanel" Visible="true" runat="server">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                         ...
                                         <asp:Label ID="Label2" runat="server" Text="Special Notes" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                     ...
                                     <div class="form-group row">
                                        <asp:Label ID="Label3" runat="server" Text="Quarter" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                    ...
                                    <br />
                                    <asp:Panel ID="MarketValue" Visible="false" runat="server">
                                     <div class="form-group row">
                ...
                <RowStyle BackColor="#EFF3FB" CssClass="rowstyle" />
                                    ...
                                    <asp:Panel ID="MarketWeight"  Visible="false" runat="server">
                                     <div class="form-group row">

                                      
                                        <div class="col-sm-12">
                                             <div class="center">
                                            <asp:GridView ID="grdMarketWeights" runat="server"   CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No Portifolio!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="false" >
                  <AlternatingRowStyle BackColor="White" CssClass="altrowstyle" />
                <EditRowStyle BackColor="#2461BF" />
                <EmptyDataRowStyle CssClass="text-warning text-center" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                ...
                <RowStyle BackColor="#EFF3FB" CssClass="rowstyle" />
                                     ...
                                     <div class="center">
                                                       <asp:Button ID="Button3" Visible="false"  class="btn btn-primary" onclick="Button3_Click2" runat="server" Text="Export To Excel" />
                                                          </div>
                                        </asp:Panel>
