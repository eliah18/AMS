    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       String op= Request.QueryString["op"];
        ...
        if (rdReportingType.SelectedItem.Value == "1")
        {
                ...
                url = "AssetClassHoldingView.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
           
        }
        else if (rdReportingType.SelectedItem.Value == "2")
        {
            url = "QuartertoQuarterInternal.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
        }
        else if (rdReportingType.SelectedItem.Value == "3")
        {
            url = "TopEquities.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
        }
        //else if (rdReportingType.SelectedItem.Value == "4")
        //{
        //    url = "PAOverWeightStructure.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
        //}
        else if (rdReportingType.SelectedItem.Value == "5")
        {
            url = "ClientMoneyMarketCounterParties.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
        }
        else if (rdReportingType.SelectedItem.Value == "6")
        {
            url = "ExposureGraph.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
        }
        else if (rdReportingType.SelectedItem.Value == "7")
        {
            //url = "~/Index.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
            url = "BarGraph.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
        }  
        else if (rdReportingType.SelectedItem.Value == "8")
        {
            url = "ComplianceMatrixView.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
        }        
        else if (rdReportingType.SelectedItem.Value == "9")
        {
            url = "AssetManagerPortfolioMovements.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
        }
        else if (rdReportingType.SelectedItem.Value == "10")
        {
            url = "PrescribedAssetsRequirement.aspx" + "?" + "clientid=" + clientid + "&year=" + year + "&quarter=" + quarter;
        }
