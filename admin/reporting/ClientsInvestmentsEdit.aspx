<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Reporting/Reporting.master" AutoEventWireup="true" CodeFile="ClientsInvestmentsEdit.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"> Reporting--Report Editing--Client Search </h4><br />
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="center">
                                        <asp:Button ID="Button2" runat="server"  visble="true" class="btn btn-primary" Text="Asset Allocation" OnClick="Button1_Click"   />
                                                  <asp:Button ID="Button6" runat="server"  visble="true" class="btn btn-primary" Text="Peformance"   />
