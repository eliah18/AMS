     ...
     <div class="inside">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                          <%--<h4 class="page-title center">&nbsp;&nbsp;Reporting>>Client Selection>>Reporting Dashboard>>Report Viewing</h4><br />--%>                       
                        
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Reporting>>Client Selection>>Reporting Dashboard>>Report Viewing</li>
                            </ol>
                        </nav>                      
                                        ...
                                        <div class="col-sm-4">
                                              <asp:dropdownlist ID="rdReportingType"   class="form-control" runat="server">
                                                  ...
                                                  <%--<asp:ListItem Value="4"> PA OverWeight Structure</asp:ListItem>--%>
                                                   ...
                                                   <asp:ListItem Value="8"> Compliance Matrix</asp:ListItem> 
                                                  <asp:ListItem Value="10"> Prescribed Assets Requirement</asp:ListItem>
                                                  <asp:ListItem Value="9"> Asset Manager Portfolio Movements</asp:ListItem>
                                                  <%--<asp:ListItem Value="6"> Exposure Graphs</asp:ListItem>--%>
                                                  <asp:ListItem Value="6"> Quarter to Quarter Exposure Pie Charts</asp:ListItem>
                                                   <%--<asp:ListItem Value="7"> Exposure Charts</asp:ListItem>--%>
                                                  <asp:ListItem Value="7"> Exposure Bar Chart</asp:ListItem>
