...
public partial class admin_parameters_User : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("AssetAllocationUpdate.aspx?clientid=" + HttpUtility.UrlEncode(txtID.Text.ToString())  + "&year=" + HttpUtility.UrlEncode(cmbYear.SelectedItem.Value) + "&quarter=" + HttpUtility.UrlEncode(rdQuarter.SelectedItem.Value));
    //    Panel2.Visible = true;
    //    String date = cmbYear.Text.Trim();
