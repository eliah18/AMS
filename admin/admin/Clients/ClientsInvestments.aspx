<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Clients/ClientStatus.master" AutoEventWireup="true" CodeFile="ClientsInvestments.aspx.cs" Inherits="admin_parameters_User" %>
                                ...
                                <div class="card-body">
                                       ...
                                       <div class="center">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="center">
                                        <asp:Button ID="Button2" runat="server"  visble="true" class="btn btn-primary" Text="Create/Edit  Report" OnClick="Button1_Click"   />
                                      ...
                                      <asp:Repeater ID="repBusAssetsIB" runat="server" OnItemCommand="repBusAssetsIB_ItemCommand">
                                            ...
                                            <FooterTemplate>
                                                ...
                                                <asp:Timer ID="Timer1"  Interval="30000" OnTick="Timer1_Tick"    runat="server"></asp:Timer>
                                                   <h4 class="card-title">Current Holdings </h4>
