...
public partial class admin_parameters_User : System.Web.UI.Page
{
    ...
    public Boolean Adduser(String firstname,String date,String ratereturn,String specialnotes,String fees,String custodian,String contact,String address ,String administrators, String clientnumber)
    {
        ...
        try
        {
            conn.Close();
            conn.Open();
            String query = "INSERT INTO clients(name,date_of_take,rate_of_return,special_notes,fees,custodian,contact_details,address,administrators,client_number,benchmark) values('" + firstname + "','" + date + "','" + ratereturn + "','" + specialnotes + "','" + fees + "','" + custodian + "','" + contact + "','" + address + "','" + administrators + "' ,'" + clientnumber + "' ,'" + txtBenchmark.Text + "')";
    ...
    public Boolean edituser(string  id)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("update clients set name='" + txtFirstName.Text + "' ,date_of_take='" + txtDate.Text + "',rate_of_return='" + txtReturn.Text + "',special_notes='" + txtSpecialnotes.Text + "' ,fees='" + txtFees.Text + "' ,custodian= '" + cmbCustodians.SelectedItem.Text + "',contact_details='" + txtContactDetails.Text + "',address='" + txtAddress.Text + "',administrators='" + cmbAdministrators.SelectedItem.Text + "' ,benchmark='"+ txtBenchmark.Text +"'  where id= '" + id + "'", conn);
            if ((conn.State == ConnectionState.Open))
                conn.Close();
            conn.Open();
            cmd.ExecuteNonQuery();
