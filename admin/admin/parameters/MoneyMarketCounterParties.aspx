<%@ Page Title="" Language="C#" MasterPageFile="~/admin/parameters/Parameter.master" AutoEventWireup="true" CodeFile="MoneyMarketCounterParties.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Money Market </h4><br />
          ...
          <asp:Panel ID="grdpanel" Visible="true" runat="server">
           <div class="row">
               <div class="col-10">
                        <div class="card">
                            <div class="card-body">
              <asp:GridView ID="grdApps" runat="server"  CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No Classes!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="True" OnPageIndexChanging="grdApps_PageIndexChanging">
                             ...
                             <%--<form class="form-horizontal">--%>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <asp:Label ID="Label2" runat="server" Text="Name" class="col-sm-3 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <asp:Label ID="Label1" runat="server" Text="Type" class="col-sm-3 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-9">
                                             <asp:DropDownList ID="cmbType" runat="server"   class="form-control"   >
                                                 <asp:ListItem Text="Prescribed" Value="Prescribed"></asp:ListItem>
