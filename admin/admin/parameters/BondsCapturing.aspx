<%@ Page Title="" Language="C#" MasterPageFile="~/admin/parameters/Parameter.master" AutoEventWireup="true" CodeFile="BondsCapturing.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Bonds Capturing </h4><br />
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Bonds</h4>
                                     ...
                                     <div class="form-group row">
                                        <asp:Label ID="Label2" runat="server" Text="Bond Type" class="col-sm-3 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-9">
                                     ...
                                     <div class="form-group row">
                                        <asp:Label ID="Label1" runat="server" Text="Bond Name" class="col-sm-3 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-9">
