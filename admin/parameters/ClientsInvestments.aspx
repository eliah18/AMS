<%@ Page Title="" Language="C#" MasterPageFile="~/admin/ClientStatus/ClientStatus.master" AutoEventWireup="true" CodeFile="ClientsInvestments.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"> Client IPSEC CAPTURE </h4><br />
                             ...
                             <%--<form class="form-horizontal">--%>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtContactNumber"  class="form-control" runat="server"></asp:TextBox>
                                            </div>
                                    ...
                                    <h4 class="card-title">IPS  Mandates</h4>
                                     ...
                                     <div class="center">     
                                        ...
                                        <div class="center"></div>
                                         <asp:Label ID="assetmanagerslabel" runat="server"  ></asp:Label>
                                        </div>
                                         <div class="form-group row">
