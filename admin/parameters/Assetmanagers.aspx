<%@ Page Title="" Language="C#" MasterPageFile="~/admin/parameters/Parameter.master" AutoEventWireup="true" CodeFile="Assetmanagers.aspx.cs" Inherits="admin_parameters_User" %>
      ...
      <div class="container-fluid">
          ...
          <asp:Panel ID="usersPanel" Visible="false" runat="server">
                             ...
                             <%--<form class="form-horizontal">--%>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        <asp:Label ID="Label8" runat="server" Text="Sub Accounts" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            <%--<asp:DropDownList ID="cmbAssetManager" runat="server"    class="form-control"  AutoPostBack="True" ></asp:DropDownList>--%>
                                            <asp:ListBox ID="cmbSubAccounts" class="form-control" runat="server"  AutoPostBack ="false"  SelectionMode="Multiple"></asp:ListBox>
                                            <br />
                                            <asp:Button ID="addSubAccounts" class="btn btn-primary" onclick="addSubAccounts_Click" runat="server" Text="Add"   /> 
                                            </div>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <asp:Label ID="LbselecdtedAssetmanagers" Visible="true" runat="server" Text="Selected SuAccounts" ></asp:Label>
                                             <asp:GridView ID="grdSelectedSubAccounts" runat="server"  CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No AssetManagers" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="True" >
                  <AlternatingRowStyle BackColor="White" CssClass="altrowstyle" />
                <EditRowStyle BackColor="#2461BF" />
                <EmptyDataRowStyle CssClass="text-warning text-center" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                ...
                <RowStyle BackColor="#EFF3FB" CssClass="rowstyle" />
                   ...
                   <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton OnClientClick="if (!confirm('Are you sure you want remove this subaccount?')) return false;" ID="lnkAssetManagerDiscard" runat="server" CommandArgument="<%# Bind('id') %>" OnClick="linkDiscardAssetManagers">Remove</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
