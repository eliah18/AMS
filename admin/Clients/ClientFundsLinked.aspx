    ...
    <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"> Client Asset Investments Capture <br /> <br /> <asp:Label ID="lblabel" runat="server" Text="Label"></asp:Label> </h4>
                ...
                <div class="row">
                    ...
                    <asp:LinkButton ID="pickdate" runat="server" onclick="pickdate_Click" class="col-sm-3 text-right control-label col-form-label">Pick Date</asp:LinkButton>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtPrice"  readonly="true" class="form-control" runat="server"></asp:TextBox>
                                    ...
                                    <asp:GridView ID="grdlistedEquity" runat="server"  CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No IPSEC!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="True" >
                        ...
                        <div class="card">
                             <%--<form class="form-horizontal">--%>
                                <div class="card-body">
                                    ...
                                    <asp:GridView ID="grdbonds" runat="server"  CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No IPSEC!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="True" >
                  <AlternatingRowStyle BackColor="White" CssClass="altrowstyle" />
                <EditRowStyle BackColor="#2461BF" />
                <EmptyDataRowStyle CssClass="text-warning text-center" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Client Money Market </h4>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                           <asp:DropDownList ID="rdCounters" runat="server" class="select2 form-control custom-select" style="width: 100%; height:36px;" AutoPostBack="True" ></asp:DropDownList>
                                            </div>
                                    ...
                                    <asp:GridView ID="grdApps" runat="server"  CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No Money Market!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="True" >
                  <AlternatingRowStyle BackColor="White" CssClass="altrowstyle" />
                <EditRowStyle BackColor="#2461BF" />
                <EmptyDataRowStyle CssClass="text-warning text-center" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                             ...
                             <%--<form class="form-horizontal">--%>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                           <asp:DropDownList ID="rdListedProperty" runat="server" class="select2 form-control custom-select" style="width: 100%; height:36px;" AutoPostBack="True" ></asp:DropDownList>
                                            </div>
                                        
                                        </div>
                                    <div class="form-group row">
                                        <asp:Label ID="Label9" runat="server" Text="Value" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                    ...
                                    <asp:GridView ID="grdListedProperty" runat="server"  CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No IPSEC!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="True" >
                  <AlternatingRowStyle BackColor="White" CssClass="altrowstyle" />
                <EditRowStyle BackColor="#2461BF" />
                <EmptyDataRowStyle CssClass="text-warning text-center" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                             ...
                             <%--<form class="form-horizontal">--%>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                           <asp:DropDownList ID="rdForeignEquity" runat="server" class="select2 form-control custom-select" style="width: 100%; height:36px;" AutoPostBack="True" ></asp:DropDownList>
                                            </div>
                                    ...
                                    <asp:GridView ID="grdforeignequity" runat="server"  CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No IPSEC!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="True" >
                  <AlternatingRowStyle BackColor="White" CssClass="altrowstyle" />
                <EditRowStyle BackColor="#2461BF" />
                <EmptyDataRowStyle CssClass="text-warning text-center" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
