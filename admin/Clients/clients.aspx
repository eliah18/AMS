<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Clients/ClientMaster.master" AutoEventWireup="true" CodeFile="clients.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"> Client Creation </h4><br />
      ...
      <div class="container-fluid">
          ...
          <asp:Panel ID="usersPanel" Visible="false" runat="server">
                             ...
                             <%--<form class="form-horizontal">--%>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <asp:Label ID="Label13" runat="server" Text="Effective Date" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            
                                           <asp:TextBox ID="txtDate"  ReadOnly="true"  class="form-control" runat="server" AutoPostBack="True"></asp:TextBox>
                                     ...
                                     <div class="form-group row">
                                        <asp:Label ID="Label10" runat="server" Text="Sponsor" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtSponsor"  class="form-control" runat="server"></asp:TextBox>
                                            
                                            </div>
                                          <asp:Label ID="Label14" runat="server" Text="Type of Client" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="rdClientType" runat="server"    class="form-control"  AutoPostBack="true" >
                                                <asp:ListItem >Pension Fund</asp:ListItem>
                                    ...
                                    <div class="form-group row">
                                        <asp:Label ID="Label4" runat="server" Text="Principal Officer" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                          ...
                                          <asp:Label ID="Label17" runat="server" Text="Email" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtReturn"  min="0.00" max="100.00" step=".01" type="number" class="form-control" runat="server"></asp:TextBox>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <asp:MaskedEditExtender ID="mskSuperPhone" runat="server" TargetControlID="txtContactDetails" Mask="(999)9999999"> </asp:MaskedEditExtender>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        <asp:Label ID="Label16" runat="server" Text="Fees per Client" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                        <asp:DropDownList ID="rdFees" runat="server" OnSelectedIndexChanged="rdFees_SelectedIndexChanged"   AutoPostBack="true"  class="form-control"   >
                                               
                                            </asp:DropDownList>
                                      
                                          </div>
                                        <asp:Label ID="Label3" runat="server" Visible="true" Text="Fee Value" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtValue" visible="true" class="form-control" runat="server"></asp:TextBox>
                                            <asp:TextBox ID="txtPercentValue" visible="false" min="0.00" max="100.00" step=".01" type="number" class="form-control" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="cmbAdministrators" runat="server"    class="form-control"   ></asp:DropDownList>
                                            
                                            </div>
                                           <asp:Label ID="Label2" runat="server" Text="Actuary" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="cmbActuary" runat="server"    class="form-control"   ></asp:DropDownList>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <asp:Label ID="Label15" runat="server" Text="Sub Account" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            <asp:ListBox ID="cmbSubAcc" class="form-control" runat="server"  AutoPostBack ="false"  SelectionMode="Multiple"></asp:ListBox>
                                            <br />
                                            <asp:Button ID="Button4" class="btn btn-primary" onclick="addSubAcc_Click" runat="server" Text="Add"   /> 
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <asp:Label ID="LbselecdtedAssetmanagers" Visible="false" runat="server" Text="Selected Managers" ></asp:Label>
                                             <asp:GridView ID="grdAssetmanagers" runat="server"  CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No Asset Managers!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="True" >
                  <AlternatingRowStyle BackColor="White" CssClass="altrowstyle" />
                <EditRowStyle BackColor="#2461BF" />
                <EmptyDataRowStyle CssClass="text-warning text-center" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                ...
                <div class="col-sm-2">
                    <asp:Label ID="lblSelectedSubAcc" Visible="false" runat="server" Text="Selected Sub Accounts" ></asp:Label>
                <asp:GridView ID="grdSubAcc" runat="server"  CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No Sub Accounts!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="True" >
                  <AlternatingRowStyle BackColor="White" CssClass="altrowstyle" />
                <EditRowStyle BackColor="#2461BF" />
                <EmptyDataRowStyle CssClass="text-warning text-center" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                ...
                <RowStyle BackColor="#EFF3FB" CssClass="rowstyle" />
                   ...
                   <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton OnClientClick="if (!confirm('Are you sure you want remove this Sub Account?')) return false;" ID="lnkDiscard" runat="server" CommandArgument="<%# Bind('id') %>" OnClick="linkDiscardSubAcc">Remove</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
              </asp:GridView>
                             ...
                             <div class="border-top">
                                 ...
                                 <asp:Button ID="Button3" runat="server" class="btn btn-primary" Text="Back" OnClick="Button3_Click" />
                                        ...
                                        <asp:Label ID="Label18" runat="server" Text="Upload File" class="col-sm-3 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-8">
                                            ...
                                            <%--left off--%>
                                            <%--<asp:Button ID="Button5" runat="server" class="btn btn-primary" visible="false" Text="Upload" OnClick="ButtonUpload_Click" />--%>
                                        </div>
                                        </div>
