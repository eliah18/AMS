<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Clients/ClientMaster.master" AutoEventWireup="true" CodeFile="clientsUpload.aspx.cs" Inherits="admin_parameters_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Historical Client Upload </h4><br />
                        ...
                        <div class="card">
                             <%--<form class="form-horizontal">--%>
                                <div class="card-body">
                                   ...
                                   <asp:Label ID="Label12" runat="server" Text="Date" class="col-sm-2 text-right control-label col-form-label" Visible="false" ></asp:Label> 
                                         <div class="col-sm-4">          
                     <asp:TextBox ID="txtDate"  Class="form-control" OnTextChanged="txtDate_TextChanged" runat="server"    AutoPostBack="true" Visible="false"></asp:TextBox>
                    <asp:LinkButton ID="pickdate" runat="server" onclick="pickdate_Click" class="col-sm-3 text-right control-label col-form-label" Visible="false">Pick Date</asp:LinkButton>
                            ...
                            <%--f.chatz--%>
                            <div class="center" >
                                        <asp:Label ID="lblOverridePrices" runat="server" Text="Prices For The Selected Date Already Exit. To Override Them Browse The Upload File And Confirm" class="col-sm-3 text-right control-label col-form-label" Visible="false"></asp:Label>
                             <div class="center">
                                <asp:Button ID="btnOverridePricesYes" runat="server" class="btn btn-primary" visible="false" Text="Confirm" OnClick="OverridePricesYes_Click" />
                                 <asp:Button ID="btnOverridePricesNo" runat="server" class="btn btn-primary" visible="false" Text="Cancel" OnClick="OverridePricesNo_Click" />
                             </div>
                                </div>
                            ...
                            <div class="center">
                             <div class="border-top">
                                    <div class="card-body">
                                        <%--<asp:Button ID="Button4" runat="server" class="btn btn-primary" Text="Save" OnClick="Button1_Click"  onClientClick="Confirm()"/>--%>
                                        <%--<asp:Button ID="Button1" runat="server" class="btn btn-primary" Text="Save" OnClick="Button1_Click" />
                                           <asp:Button ID="Button2" runat="server" class="btn btn-primary" visible="false" Text="Save" OnClick="Button2_Click" />
    ...
    <script type="text/javascript">
        ...
        <%--function Confirm()
        {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("123 Prices For The Selected Date Already Exit. Are You Sure You Want To Override The Prices?")) {
                
                document.getElementById('<%=hdn.ClientID%>').value = "Yes";
                alert(document.getElementById('<%=hdn.ClientID%>').value);
            }
            else {
