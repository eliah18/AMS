<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Clients/ClientMaster.master" AutoEventWireup="true" CodeFile="ClientsIpsecSetup.aspx.cs" Inherits="admin_parameters_User" %>
     ...
     <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title"> Client Ipsec </h4><br />
                                    ...
                                    <h4 class="card-title">IPS  Asset Allocation/Mandates</h4>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <asp:RadioButtonList ID="RadioButtonList1" RepeatDirection="Horizontal"  OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" AutoPostBack="true" CellPadding="4" CellSpacing="4" runat="server">
                                                ...
                                                <asp:ListItem Value="AssetManager">Asset Manager</asp:ListItem>
                                            </asp:RadioButtonList>
                                     ...
                                     <div class="form-group row">
                                      ...
                                      <%-- <div class="form-group row">
                                            <asp:Label ID="Label113" runat="server" Visible="false" Text="Asset Classes" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                            <asp:TextBox ID="txtAssetclass4Edit" visible="false"  class="form-control" runat="server"></asp:TextBox>
                                        </div>--%>
                                        ...
                                        <%--<div class="form-group row">
                                         ...
                                         <asp:Label ID="Label3" runat="server" Visible="true" Text="Corridor" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            <asp:textbox ID="txtCorridor" Visible="true" runat="server" class="form-control" style="width: 100%; height:36px;" ></asp:textbox>
                                            </div>
                                            </div>--%>
                                            ...
                                            <asp:Label ID="Label9" runat="server" Visible="true" Text="Corridor(Top)" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            <asp:textbox ID="txtCorridorTop" Visible="true" runat="server" class="form-control" style="width: 100%; height:36px;" ></asp:textbox>
                                            </div>
                                                </div>
                                                 <div class="form-group row">

                                            <asp:Label ID="Label15" runat="server" Visible="true" Text="Corridor(Bottom)" class="col-sm-2 text-right control-label col-form-label"></asp:Label>
                                        <div class="col-sm-4">
                                            <asp:textbox ID="txtCorridorBottom" Visible="true" runat="server" class="form-control" style="width: 100%; height:36px;" ></asp:textbox>
                                            </div>
                                     ...
                                     <div class="center">     
                                        ...
                                        <div class="col-sm-10">
                                             <div class="center">
                                            <asp:GridView ID="grdClientIpsecs" runat="server" CellPadding="1" CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No IPSEC!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" AllowPaging="False" >
