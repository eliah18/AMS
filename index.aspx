                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red">
                                        <span class="caption-subject bold uppercase">Investment Portfolio </span>
                                    </div>
                                </div>
...
<%--        <script type="text/javascript" src="assetsG/global/plugins/jquery-idle-timeout/jquery.idletimeout.js"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $.ajax({
                    type: "get",
                    url: `getGraphdata.asmx/GetRegData?clientid=${clientid1}&quarter=${quarter1}&year=${year1}`,
                    data: { clientid: clientid1, quarter: quarter1, year: year1 },
